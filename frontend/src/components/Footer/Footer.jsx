      ...
      <div className="as-container">
        ...
        <div className="as-top">
          ...
          <div className="as-col as-brand">
            ...
            <h3 className="as-title">CV Validator & Job Recommendation System</h3>
            ...
            <p className="as-desc">
              ...
              recruitment criteria. The system uses intelligent skill extraction,
              structured scoring, and fairness-focused Blind Mode to support
              unbiased hiring and student career development.
            </p>
